...
import { setactiveProject, setToken } from "./redux";
    ...
    return (
        <div className="border-1 p-1 w-[350px] h-[750px] rounded-4xl shadow-xl bg-white flex flex-col gap-2 ml-auto  xs:w-[280px]">
            ...
            <div className="flex flex-col gap-2 pl-2 ">
                ...
                <h1 id="settings" className="hover:bg-zinc-200 h-[35px] text-lg cursor-pointer font-medium" onClick={clearToken}>Sign Out</h1>
            </div>
